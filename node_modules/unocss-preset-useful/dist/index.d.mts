import { StaticShortcut, CSSObject, PresetFactory } from '@unocss/core';
import { AttributifyOptions } from '@unocss/preset-attributify';
import { IconsOptions } from '@unocss/preset-icons';
import { Theme, ThemeAnimation } from '@unocss/preset-mini';
...
import { PresetScrollbarDefaultOption } from 'unocss-preset-scrollbar';
...
interface UsefulExtends extends Exclude<UsefulTheme, 'extend'> {
...
interface UsefulTheme extends Theme {
...
declare const presetUseful: PresetFactory<UsefulTheme, UsefulOptions>;

export { type UsefulOptions, type UsefulTheme, animationRegExp, camelToHyphen, cssObj2StrAsync, cssObj2StrSync, deepMerge, presetUseful as default, getKeyframes, isObject, presetUseful, resolveAnimation, stringifyObj, toArray };
