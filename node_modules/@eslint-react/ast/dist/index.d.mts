...
declare const isFunction: (node: TSESTree.Node | null | undefined) => node is Extract<TSESTree.Node, {
    type: AST_NODE_TYPES$1.ArrowFunctionExpression | AST_NODE_TYPES$1.FunctionDeclaration | AST_NODE_TYPES$1.FunctionExpression;
}>;
declare const isFunctionType: (node: TSESTree.Node | null | undefined) => node is Extract<TSESTree.Node, {
    type: AST_NODE_TYPES$1.ArrowFunctionExpression | AST_NODE_TYPES$1.FunctionDeclaration | AST_NODE_TYPES$1.FunctionExpression | AST_NODE_TYPES$1.TSCallSignatureDeclaration | AST_NODE_TYPES$1.TSConstructSignatureDeclaration | AST_NODE_TYPES$1.TSDeclareFunction | AST_NODE_TYPES$1.TSEmptyBodyFunctionExpression | AST_NODE_TYPES$1.TSFunctionType | AST_NODE_TYPES$1.TSMethodSignature;
}>;
declare const isClass: (node: TSESTree.Node | null | undefined) => node is Extract<TSESTree.Node, {
    type: AST_NODE_TYPES$1.ClassDeclaration | AST_NODE_TYPES$1.ClassExpression;
}>;
...
declare const isArrayTupleType: (node: TSESTree.Node | null | undefined) => node is Extract<TSESTree.Node, {
    type: AST_NODE_TYPES$1.TSArrayType | AST_NODE_TYPES$1.TSTupleType;
}>;
declare const isProperty: (node: TSESTree.Node | null | undefined) => node is Extract<TSESTree.Node, {
    type: AST_NODE_TYPES$1.PropertyDefinition | AST_NODE_TYPES$1.TSIndexSignature | AST_NODE_TYPES$1.TSParameterProperty | AST_NODE_TYPES$1.TSPropertySignature;
}>;
...
declare const isJSX: (node: TSESTree.Node | null | undefined) => node is Extract<TSESTree.Node, {
    type: AST_NODE_TYPES$1.JSXAttribute | AST_NODE_TYPES$1.JSXClosingElement | AST_NODE_TYPES$1.JSXClosingFragment | AST_NODE_TYPES$1.JSXElement | AST_NODE_TYPES$1.JSXEmptyExpression | AST_NODE_TYPES$1.JSXExpressionContainer | AST_NODE_TYPES$1.JSXFragment | AST_NODE_TYPES$1.JSXIdentifier | AST_NODE_TYPES$1.JSXMemberExpression | AST_NODE_TYPES$1.JSXNamespacedName | AST_NODE_TYPES$1.JSXOpeningElement | AST_NODE_TYPES$1.JSXOpeningFragment | AST_NODE_TYPES$1.JSXSpreadAttribute | AST_NODE_TYPES$1.JSXSpreadChild | AST_NODE_TYPES$1.JSXText;
}>;
declare const isJSXTagNameExpression: (node: TSESTree.Node | null | undefined) => node is Extract<TSESTree.Node, {
    type: AST_NODE_TYPES$1.JSXIdentifier | AST_NODE_TYPES$1.JSXMemberExpression | AST_NODE_TYPES$1.JSXNamespacedName;
}>;
declare const isDestructuringPattern: (node: TSESTree.Node | null | undefined) => node is Extract<TSESTree.Node, {
    type: AST_NODE_TYPES$1.ArrayPattern | AST_NODE_TYPES$1.AssignmentPattern | AST_NODE_TYPES$1.ObjectPattern | AST_NODE_TYPES$1.RestElement;
}>;
declare const isTypeDeclaration: (node: TSESTree.Node | null | undefined) => node is Extract<TSESTree.Node, {
    type: AST_NODE_TYPES$1.TSInterfaceDeclaration | AST_NODE_TYPES$1.TSTypeAliasDeclaration;
}>;
declare const isLeftHandSideExpression: (node: TSESTree.Node | null | undefined) => node is Extract<TSESTree.Node, {
    type: AST_NODE_TYPES$1.ArrayExpression | AST_NODE_TYPES$1.ArrayPattern | AST_NODE_TYPES$1.ArrowFunctionExpression | AST_NODE_TYPES$1.CallExpression | AST_NODE_TYPES$1.ClassExpression | AST_NODE_TYPES$1.FunctionExpression | AST_NODE_TYPES$1.Identifier | AST_NODE_TYPES$1.JSXElement | AST_NODE_TYPES$1.JSXFragment | AST_NODE_TYPES$1.Literal | AST_NODE_TYPES$1.MemberExpression | AST_NODE_TYPES$1.MetaProperty | AST_NODE_TYPES$1.ObjectExpression | AST_NODE_TYPES$1.ObjectPattern | AST_NODE_TYPES$1.SequenceExpression | AST_NODE_TYPES$1.Super | AST_NODE_TYPES$1.TaggedTemplateExpression | AST_NODE_TYPES$1.TemplateLiteral | AST_NODE_TYPES$1.ThisExpression;
}>;
declare const isLeftHandSideExpressionType: (node: TSESTree.Node | null | undefined) => node is Extract<TSESTree.Node, {
    type: AST_NODE_TYPES$1.ArrayExpression | AST_NODE_TYPES$1.ArrayPattern | AST_NODE_TYPES$1.ArrowFunctionExpression | AST_NODE_TYPES$1.CallExpression | AST_NODE_TYPES$1.ClassExpression | AST_NODE_TYPES$1.FunctionExpression | AST_NODE_TYPES$1.Identifier | AST_NODE_TYPES$1.JSXElement | AST_NODE_TYPES$1.JSXFragment | AST_NODE_TYPES$1.Literal | AST_NODE_TYPES$1.MemberExpression | AST_NODE_TYPES$1.MetaProperty | AST_NODE_TYPES$1.ObjectExpression | AST_NODE_TYPES$1.ObjectPattern | AST_NODE_TYPES$1.SequenceExpression | AST_NODE_TYPES$1.Super | AST_NODE_TYPES$1.TaggedTemplateExpression | AST_NODE_TYPES$1.TemplateLiteral | AST_NODE_TYPES$1.ThisExpression | AST_NODE_TYPES$1.TSAsExpression | AST_NODE_TYPES$1.TSNonNullExpression | AST_NODE_TYPES$1.TSTypeAssertion;
}>;
