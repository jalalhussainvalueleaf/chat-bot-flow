...
import { O, isString, isObject, MutRef, F, isNullable } from '@eslint-react/tools';
...
var filename_default = createRule({
  ...
  create(context) {
    ...
    const extensions = isObject(options) && "extensions" in options ? options.extensions : defaultOptions2[0].extensions;
