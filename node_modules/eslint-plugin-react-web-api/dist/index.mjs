...
import { isInversePhase, PHASE_RELEVANCE, getPhaseKindOfFunction } from '@eslint-react/core';
import * as JSX from '@eslint-react/jsx';
import { Data, O, F, or, not, isBoolean } from '@eslint-react/tools';
...
function isInstanceIDEqual(a, b, context) {
  return AST2.isNodeEqual(a, b) || VAR2.isNodeValueEqual(a, b, [context.sourceCode.getScope(a), context.sourceCode.getScope(b)]);
}
...
var defaultOptions = Data.struct({
...
function getOptions(node, initialScope) {
  ...
  function getOpts(node2) {
    switch (node2.type) {
      ...
      case AST_NODE_TYPES.Literal: {
        return Data.struct({ ...defaultOptions, capture: O.some(!!node2.value) });
      }
